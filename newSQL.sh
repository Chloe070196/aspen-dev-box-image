...
VALUES(2,'ils','Koha','barcode_pin','ils','http://koha-koha-1:8080','http://koha-koha-1:8080','ils',2,'koha-db-1','koha_kohadev','koha_kohadev','password',NULL,NULL,NULL,NULL,3306,'GMT',NULL,NULL,'koha',NULL,NULL,NULL,NULL,NULL);
UNLOCK TABLES;
